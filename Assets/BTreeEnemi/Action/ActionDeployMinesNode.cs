...
public class DeployMinesNode : ActionNode
{
    ...
    private float _dropDistance = 2f; // Distance derrière le tank pour déposer les mines
    ...
    {
        _tankGameObject = base.blackboard.Get("targetGameObject") as GameObject;
        _transform = _tankGameObject.GetComponent<Transform>();
        _minePrefab = base.blackboard.Get("minePrefab") as GameObject;
